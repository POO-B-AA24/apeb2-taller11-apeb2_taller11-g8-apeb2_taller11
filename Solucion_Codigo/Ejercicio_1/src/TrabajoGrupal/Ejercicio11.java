    ...
    public static void main(String[] args) {
        ...
        while (c < 2) {
            switch (inicio) {
                ...
                case 3:
                    System.out.println("\nESTE JUEGO ESTA DEDICADO A TODOS LOS APASIONADOS DE LOS JUEGOS DE ROL Y A NUESTRO PROFESOR EL ING. DANIEL IRENE.");
                    System.out.println("ESPERAMOS QUE DISFRUTEN DE DUELO DE LEYENDAS TANTO COMO NOSOTROS DISFRUTAMOS CREANDOLO.\n");
                    break;
    ...
    public int getDano(String hechizo) {
        ...
        switch (hechizo) {
            ...
            case "Tormenta Eléctrica":
                ...
                break;
            default:
                System.out.println("Hechizo no reconocido.");
        }
